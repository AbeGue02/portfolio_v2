...
import { css, django, expo, expressjs, github, html, javaScript, mongodb, nodejs, python, react, reactNative, sql } from "./skills";
...
const projects: Project[] = [
    {
        ...
        `,
        skills: [
            reactNative, expressjs, mongodb, nodejs, javaScript, expo, github
        ],
    ...
    },
    {
        ...
        skills: [
            react, expressjs, mongodb, nodejs, css, html, javaScript, github
        ],
        pictures: [
    ...
    },
    {
        ...
        skills: [
            html, javaScript, css, nodejs, github
        ],
        pictures: [
